...
typedef enum {
	...
	CAN_PACKET_STATUS,/*获取电机状态信息*/
	CAN_PACKET_SET_CURRENT_REL,
	CAN_PACKET_SET_CURRENT_BRAKE_REL,
	CAN_PACKET_SET_CURRENT_HANDBRAKE,/*手刹电流*/
...
MOTOR_PROPERTY;//从vesc电调读取电机相关的状态信息
